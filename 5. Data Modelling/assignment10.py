...
Provided_Portion = 0.50

sample_rate, wave = wavfile.read("Datasets/recordings/0_jackson_0.wav")
...
#
# .. your code here ..
X_test = test[0:Provided_Portion*len(test)]
...
#
# .. your code here ..
y_test = test[-(1-Provided_Portion*len(test)-1) :]
...
y_train = train[:, -(1-Provided_Portion*n_audio_samples-1) :]
