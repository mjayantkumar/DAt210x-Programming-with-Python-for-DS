...
#
# .. your code here ..
crd = pd.read_csv("Datasets/CDR.csv")
crd.CallDate = pd.to_datetime(crd['CallDate'])
crd.CallTime = pd.to_timedelta(crd['CallTime'])
#
...
#
# .. your code here ..
user1 = user1.query('DOW == "Sat" or DOW == "Sun"')
...
#
# .. your code here ..
user1 = user1[user1.CallTime > '06:00:00']
...
#
# .. your code here ..
user_kmeans = user1.loc[:, ['TowerLon', 'TowerLat']]
kmeans_model = KMeans(n_clusters=1)
kmeans_model.fit(user_kmeans)
